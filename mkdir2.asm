...
{    
  ...
  1e:	6a 01                	push   $0x1
  20:	e8 bb 03 00 00       	call   3e0 <printf>
...
free(void *ap)
{
 ...
 591:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 607:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60a:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	39 05 3c 0a 00 00    	cmp    %eax,0xa3c
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 40 0a 00 00       	mov    $0xa40,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 6e6:	0a 00 00 
    base.s.size = 0;
 6e9:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 6f0:	00 00 00 
    if(p->s.size >= nunits){
