  ...
  32:	00 00 00 
{
  ...
  6d:	57                   	push   %edi
  6e:	e8 6d 00 00 00       	call   e0 <strcpy>
		p += strlen(argv[i]) + 1;
  73:	58                   	pop    %eax
  74:	ff 34 b3             	push   (%ebx,%esi,4)
  77:	e8 f4 00 00 00       	call   170 <strlen>
		if (p >= msg + sizeof(msg))
  ...
  9a:	e8 2c 03 00 00       	call   3cb <shutdown2>
 ...
 631:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 6a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6aa:	89 15 d4 0a 00 00    	mov    %edx,0xad4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70b:	39 05 d4 0a 00 00    	cmp    %eax,0xad4
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 d8 0a 00 00       	mov    $0xad8,%eax
    base.s.ptr = freep = prevp = &base;
